...
FOCUS = "проектированию зданий (архитектурные и конструктивные решения, ГОСТ, СП, СНиП)"
...
async def cmd_gost(message: types.Message) -> None:
    ...
    try:
        prompt = (
            ...
            f"Составь список нормативных документов (ГОСТ, СП, СНиП, приказы Минстроя) "
            f"по теме: «{topic}».\n\n"
            f"Формат ответа:\n"
            f"### Раздел (например, «Фундаменты»)\n"
